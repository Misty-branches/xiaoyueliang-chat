...
class DiaryDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (entry == null) {
      return Scaffold(body: Center(child: Text('未找到日记', style: TextStyle(color: MoonlitColors.lightInkSec))));
    }
        ...
        return Padding(
          ...
          child: Text(
            ...
            style: TextStyle(
              ...
              backgroundColor: hl ? c.warm.withValues(alpha: c.bg == MoonlitColors.darkBg ? 0.15 : 0.25) : null,
            ),
          ),
        );
      }).toList(),
